<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhotoUpload.aspx.cs" Inherits="OneC.OnBoarding.WebApp.Roles.NHPages.Paperwork.SaudiArabia.PhotoUpload" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../../Scripts/Forms/SaudiArabia/PhotoUpload.js" type="text/javascript"></script>
                                ...
                                <div id="main" style="display: block; overflow: scroll; height: 350px; position:relative">
                                    ...
                                    <div class="photo_info" style="float: right">
                                        ...
                                        <p class="paddingB20">
                                         ...
                                         <input type="button" style="display:none; background:url(../../../../Images/btnprint.png) ; width:120px; height:24px; border:none; cursor:pointer; color:#fff; "  id="UpdatePrintStatus" title="Print ID Card" value="Print ID Card"
