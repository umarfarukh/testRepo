...
$().ready(function () {
    ...
    if ($("#Pg_1_text_BasicAmt").val() == "") {
        OBPager.SetTaskContentMemberValue('ManitobaTax.BasicPersonalamt', null, 9134, true);
    }
    OBPager.ShowPage(1);
    ValidateOnlyInteger();
...
function ResetTaskData() {
    ...
    if (OBPager.taskStatusFlag == -1) {
        ...
        $("#Pg_1_text_SSN").val(TaskPrefillValues.PrefillValues.Set1.SSN);
        $("#Pg_2_text_SignatureDate").val(TaskPrefillValues.PrefillValues.Set1.SubmissionDate);
        OBPager.SetTaskContentMemberValue('ManitobaTax.BasicPersonalamt', null, 9134, false);
        OBPager.SetTaskContentMemberValue('ManitobaTax.TotalClaimAmt', null, 9134, true);
