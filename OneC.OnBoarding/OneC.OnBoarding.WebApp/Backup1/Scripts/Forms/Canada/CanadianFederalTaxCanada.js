...
$('.currentDate').html(JSON.parse(OBPager.strFormDetails).PersonalTax.CurrentDate);
    ...
    if ($("#Pg_1_text_BasicAmt").val() == "") {
        //$("#Pg_1_text_BasicAmt").val("11138");
        OBPager.SetTaskContentMemberValue('PersonalTax.BasicPersonalamt', null, 11138, true);
    }
    OBPager.ShowPage(1);
    //    DisableCutCopyPaste();
    ValidateOnlyInteger();
...
function ResetTaskData() {
    ...
    if (OBPager.taskStatusFlag == -1) {
        ...
        $("#Pg_1_text_SSN").val(TaskPrefillValues.PrefillValues.Set1.SSN);
        $("#Pg_2_text_SignatureDate").val(TaskPrefillValues.PrefillValues.Set1.SubmissionDate);
        OBPager.SetTaskContentMemberValue('PersonalTax.BasicPersonalamt', null, 11138, false);
        OBPager.SetTaskContentMemberValue('PersonalTax.TotalClaimAmt', null, 11138, true);
