//-----------------------------------------------------------------------
// <copyright file="Constants.cs" company="External">
...
namespace com.qas.prowebintegration
{
    ...
    public class Constants
    {
        ...
        /// <summary>
        /// configuration hey layout
        /// </summary>
        public const string KEY_LAYOUT = "com.qas.proweb.layout";

        /// <summary>
        /// field for FORMAT ADDRESS IN PICK LIST
        /// </summary>
        public const string KEY_FORMATADDRESSINPICKLIST = "com.qas.proweb.formatAddressInPicklist";

        /// <summary>
        ///  Filename of common fin   al, address confirmation, page
        /// </summary>
        ...
        /// <summary>
        /// field for getting all countries
        /// </summary>
        ...
        public enum Routes
        {
            ...
            /// <summary>
            /// Pick list returned with TooManyMatches flag
            /// </summary>
            TooManyMatches,            // Picklist returned with TooManyMatches flag

            /// <summary>
            /// Pick list returned empty
            /// </summary>
            NoMatches,                    // Picklist returned empty

            /// <summary>
            /// Pick list returned with Timeout flag
            /// </summary>
