        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg.d == 1) {
                    ...
                    if (loopDay == 1 && Day1Flag == 1) {
                        DayFlag = 1;
                        dataString = '{trainingId:' + 0 + "," + 'candidateId:' + 0 + "," + 'candidateIDs:' + "'" + IdToSendMail + "'" + ',countryId:' + "'" + country + "'" + ',mode:3' + ',dayFlag:' + "'" + DayFlag + "'" + '}';
                    }
                    if (loopDay == 2 && Day2Flag == 1) {
                        DayFlag = 2;
                        dataString = '{trainingId:' + 0 + "," + 'candidateId:' + 0 + "," + 'candidateIDs:' + "'" + IdToSendMailSMAbv + "'" + ',countryId:' + "'" + country + "'" + ',mode:3' + ',dayFlag:' + "'" + DayFlag + "'" + '}';
                    }
                    $.ajax({
                        type: "POST",
