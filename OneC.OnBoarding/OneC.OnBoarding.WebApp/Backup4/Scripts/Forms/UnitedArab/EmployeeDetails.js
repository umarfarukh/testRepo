    ...
    jQXB.addOnTemplateItemBoundhnd(function (dataSourceName, templateName, occurrency, dataItem, jQrytemplateItem) {
        switch (templateName) {
            case "EmployerTemplate": // filter only event databound from a specific template
                ...
                else if (occurrency == 1) {
                    $(employerRecord).text('Current /Last Employer');
                }
                else {
...
function IsCogAttended(flag) {
    if (flag == 1) {
        OBPager.SetTaskContentMemberValue('EmployersData.IsCognizantAttended.Yes', 1, '1', false);
        OBPager.SetTaskContentMemberValue('EmployersData.IsCognizantAttended.No', 1, '', false);
    }
    else {
        OBPager.SetTaskContentMemberValue('EmployersData.IsCognizantAttended.No', 1, '1', false);
        OBPager.SetTaskContentMemberValue('EmployersData.IsCognizantAttended.Yes', 1, '', false);
    }
}


function AuthPresentEmp(flag) {
    if (flag == 1) {
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPresentEmployer.Yes', 1, 'true', false);
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPresentEmployer.No', 1, '', false);
    }
    else {
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPresentEmployer.No', 1, 'true', false);
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPresentEmployer.Yes', 1, '', false);
    }
}


function AuthPastEmp(flag) {
    if (flag == 1) {
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPastEmployer.Yes', 1, 'true', false);
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPastEmployer.No', 1, '', false);
    }
    else {
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPastEmployer.No', 1, 'true', false);
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPastEmployer.Yes', 1, '', false);
    }
}


function AuthSchool(flag) {
    if (flag == 1) {
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPreviousSchools.Yes', 1, 'true', false);
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPreviousSchools.No', 1, '', false);
    }
    else {
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPreviousSchools.No', 1, 'true', false);
        OBPager.SetTaskContentMemberValue('EmployersData.AuthPreviousSchools.Yes', 1, '', false);
    }
}
