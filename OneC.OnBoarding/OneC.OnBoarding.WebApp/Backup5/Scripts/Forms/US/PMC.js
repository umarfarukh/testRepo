//Preparing form
$().ready(function () {
    $("#pg_1_text_empname").val(TaskPrefillValues.PrefillValues.Set1.Name);
    ...
    $("#Pg_1_text_city").val(TaskPrefillValues.PrefillValues.Set1.City);
    $("#Pg_1_text_state").val(TaskPrefillValues.PrefillValues.Set1.State);
    $("#Pg_1_text_zip").val(TaskPrefillValues.PrefillValues.Set1.Zip);
    OBPager.ShowPage(1);
});
