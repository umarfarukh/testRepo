$().ready(function () {
    ...
    if ($("#Pg_1_text_BasicAmt").val() == "") {
        OBPager.SetTaskContentMemberValue('ProvincialTaxOntario.BasicPersonalamt', null, 8943, true);
    }
...
function ResetTaskData() {
   ...
   if (OBPager.taskStatusFlag == -1) {
       ...
       $("#Pg_2_text_SignatureDate").val(TaskPrefillValues.PrefillValues.Set1.SubmissionDate);
       OBPager.SetTaskContentMemberValue('ProvincialTaxOntario.BasicPersonalamt', null, 8943, true);
       OBPager.SetTaskContentMemberValue('ProvincialTaxOntario.TotalClaimAmt', null, 8943, true);
