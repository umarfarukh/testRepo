        ...
        if ((OBPager.taskStatusFlag != "-1") && (TaskPrefillValues.PrefillValues.Set1.TrainingId != "-1")) {
            ...
            if (TaskPrefillValues.PrefillValues.Set1.AttendanceStatus == 1) {
                ...
                if (TaskPrefillValues.PrefillValues.Set1.IsAttemptsProvided == 1) {
                    ...
                    $("#note").text("Note* : You will be allowed to modify the registration date twice from the first time you register online.");
                }
...
function TrainingSelectindexChange() {
    ...
    if (document.getElementById('TrainingId').value == -1) {
       ...
       // document.getElementById('Pg_1_text_City').value = "";
        ...
        var datastring = "{";
        datastring += "'trainingId':" + document.getElementById('TrainingId').value + ",";
        datastring += "'countryId':" + parseInt(countryId.toString()) + ",";
        datastring += "'sessionId':" + parseInt(sessionId.toString());
        datastring += "}";
        $.ajax({
            type: "POST",
...
function RegisterCancel(Mode) {
    ...
    else if (Mode == 1 && (document.getElementById('TrainingId').value == TaskPrefillValues.PrefillValues.Set1.TrainingId) && document.getElementById('TrainingId').value) {
    formClose=1;
