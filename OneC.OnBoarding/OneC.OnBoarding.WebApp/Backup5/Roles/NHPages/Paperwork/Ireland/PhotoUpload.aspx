<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhotoUpload.aspx.cs" Inherits="OneC.OnBoarding.WebApp.Roles.NHPages.Paperwork.Ireland.PhotoUpload" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../../Scripts/Forms/Ireland/PhotoUpload.js" type="text/javascript"></script>
                                ...
                                <div>
                                    <div class="pre fleft" style="float: left; padding-right: 0px; width: 50%;">
                                        ...
                                        <p class="font14 color_pre paddingTB10">
                                            <a href="#">Do's</a></p>
                                        <ul>
                                            <li>You should be in "Business casual" attire and against plain
                                                <br />
