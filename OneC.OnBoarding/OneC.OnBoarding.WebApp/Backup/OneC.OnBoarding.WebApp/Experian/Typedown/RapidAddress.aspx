<%@ Page language="c#" Inherits="com.qas.prowebintegration.RapidAddress" EnableEventValidation="false" Codebehind="RapidAddress.aspx.cs" %>
	...
	<HEAD>
		...
		<script type="text/javascript">
			...
			function init()
			{
				try 
				{
				    document.getElementById("<%= Constants.FIELD_ADDRESS_LINES %>" + "0" ).focus();
				}
				catch(e) 
				{ 
				...
				<%
				 ...
				 %>
                 //hide country
                    document.getElementById("AddressLine6").style.display = 'none';
                //read only fields
                document.getElementById("AddressLine0").setAttribute("readOnly", "true");
                document.getElementById("AddressLine1").setAttribute("readOnly", "true");
                document.getElementById("AddressLine2").setAttribute("readOnly", "true");
                document.getElementById("AddressLine3").setAttribute("readOnly", "true");
                document.getElementById("AddressLine4").setAttribute("readOnly", "true");
                document.getElementById("AddressLine5").setAttribute("readOnly", "true");
			} 
            ...
            var locationValue;
                ...
                if (document.getElementById("AddressLine7"))
                    {
			        locationValue = document.getElementById("AddressLine7").value;
                    }
				if (locationValue==" ") {
					...
					<td class="main">
						<div class="toolbar">
							<span class="first margin">
							    <button id="ButtonNew" style="width:40;height:25" type="button" runat="server" accessKey="N" onserverclick="ButtonNew_ServerClick"><EM>N</EM>ew</button>
							    &nbsp;
							    <button id="ButtonBack" style="width:40;height:25" type="button"  runat="server" accessKey="B" onserverclick="ButtonBack_ServerClick"><EM>B</EM>ack</button> 
						    </span>
							<span class="margin">
							...
							<span class="last margin">
							    <label id="lblCountry" for="country" ><em>C</em>ountry:</label>
						...
						<div class="prompt">
							...
							<button id="Accept" type="submit" accessKey="A" onclick="return finish();"><EM>A</EM>ccept</button>
						</div>
					</td>
				</tr>
				<tr>	
