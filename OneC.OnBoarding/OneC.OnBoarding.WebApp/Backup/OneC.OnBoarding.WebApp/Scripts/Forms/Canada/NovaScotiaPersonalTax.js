...
$().ready(function () {
    ...
    if (OBPager.taskStatusFlag == -1) {
        ...
        OBPager.SetTaskContentMemberValue('NovaScotiaPersonalTax.CurrentDate', null, (TaskPrefillValues.PrefillValues.Set1.Date), true);
    }
    if ((OBPager.taskStatusFlag == 1) || (OBPager.taskStatusFlag == 0)) {

        $('.currentDate').html(JSON.parse(OBPager.strFormDetails).NovaScotiaPersonalTax.CurrentDate);
    }
    if ($("#Pg_1_text_BasicAmt").val() == "") {
        OBPager.SetTaskContentMemberValue('NovaScotiaPersonalTax.BasicPersonalamt', null, 8481, true);
    }
...
function ResetTaskData() {
    ...
    if (OBPager.taskStatusFlag == -1) {
        ...
        OBPager.SetTaskContentMemberValue('NovaScotiaPersonalTax.BasicPersonalamt', null, 9134, false);
        OBPager.SetTaskContentMemberValue('NovaScotiaPersonalTax.TotalClaimAmt', null, 9134, true);
...
//    }
    if (Total.toString().indexOf(".") > 0) {
        OBPager.SetTaskContentMemberValue('NovaScotiaPersonalTax.TotalClaimAmt', null, Total.toFixed(2), false);
        $("#Pg_1_text_TotalClaimAmt").val(Total.toFixed(2));
    }
    else {
        OBPager.SetTaskContentMemberValue('NovaScotiaPersonalTax.TotalClaimAmt', null, parseInt(Total), false);
