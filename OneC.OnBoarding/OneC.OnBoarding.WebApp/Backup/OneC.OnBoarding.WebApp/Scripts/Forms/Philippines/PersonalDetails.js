...
//            var PerCity = JSON.parse(OBPager.strFormDetails).PersonalData.CurrentCity;
//            var OthPerCity = JSON.parse(OBPager.strFormDetails).PersonalData.OtherCurrentCity;
//            if (PerCity == "Others") {
//                OBPager.SetTaskContentMemberValue('PersonalData.OtherPermanentCity', null, OthPerCity, false);
//                $('#OtherPermanentCity').show();
//            }
//            else {
//                $('#permcity_form').removeAttr('disabled');
...
//            var LngCity = JSON.parse(OBPager.strFormDetails).PersonalData.CurrentCity;
//            var OthLngCity = JSON.parse(OBPager.strFormDetails).PersonalData.OtherCurrentCity;
//            if (LngCity == "Others") {
//                OBPager.SetTaskContentMemberValue('PersonalData.OtherLongestCity', null, OthLngCity, false);
//                $('#OtherLongestStayCity').show();
//            }
...
//            var lngcityId = $("#currcity_form option:selected").text();
//            if (lngcityId.indexOf('Others') >= 0) {

//                OBPager.SetTaskContentMemberValue('PersonalData.LongestStayCity', null, $('#currcity_form').val(), false);
//                $('#OtherLongestStayCity').show();
//                OBPager.SetTaskContentMemberValue('PersonalData.OtherLongestCity', null, $('#OtherLongestStayCity').val(), false);
//            }
//            else {
//                OBPager.SetTaskContentMemberValue('PersonalData.LongestStayCity', null, $('#currcity_form').val(), false);
//                $('#OtherLongestStayCity').hide();
//            }
            // $('#lngstycity_form').attr("disabled", "false")
