...
$().ready(function () {
    ...
    if ((TaskId == 18 || TaskId == 235 || TaskId == 28 || TaskId == 720 || TaskId == 721) && (TaskStatus == 1)) {
...
function UpdateCandidateInfo() {
    ...
    if (flag == true) {
        ...
        //var inputData = '{ "candidate":"' + candidateValue + '","candidateDOJ" : "' + dojValue + '","emailId" : "' + emailidValue + '","resendMail":"' + ResendMailval + '","joiningStatus":"' + joiningStatus + '","rcComment":"' + RCComment + '","resendI9Mail":"0"}';
...
////Niranjana(147440) has confirmed to remove this cancel option. 
...
function DOJConfirm(candidateid) {
    ...
    //var inputData = '{ "candidateid":"' + candidateValue + '" }';
