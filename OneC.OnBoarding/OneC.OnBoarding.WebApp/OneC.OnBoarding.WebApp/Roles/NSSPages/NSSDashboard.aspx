    ...
    function FetchDrill(CandidateID) {
        ...
        $.ajax({
            ...
            complete: function () {
                ...
                if ($("[id='txtDeliveryDate_Laptop issued by cognizant']").val() == "1/1/1900" || $("[id='txtDeliveryDate_Laptop issued by cognizant']").val() == "") {
                    $("[id='txtDeliveryDate_Laptop issued by cognizant']").removeAttr('readOnly');
                    getCurrentDate($("[id='txtDeliveryDate_Laptop issued by cognizant']"));
                    $("[id='txtDeliveryDate_Laptop issued by cognizant']").attr('readOnly', 'readOnly');
                }

                if ($('#txtDeliveryDate_AndroidDevice').val() == "1/1/1900" || $('#txtDeliveryDate_AndroidDevice').val() == "") {
                    $('#txtDeliveryDate_AndroidDevice').removeAttr('readOnly');
                    getCurrentDate($('#txtDeliveryDate_AndroidDevice'));
                    $('#txtDeliveryDate_AndroidDevice').attr('readOnly', 'readOnly');
                }

                if ($('#txtDeliveryDate_ClientLaptop').val() == "1/1/1900" || $('#txtDeliveryDate_ClientLaptop').val() == "") {
                    $('#txtDeliveryDate_ClientLaptop').removeAttr('readOnly');
                    getCurrentDate($('#txtDeliveryDate_ClientLaptop'));
                    $('#txtDeliveryDate_ClientLaptop').attr('readOnly', 'readOnly');
                }
...
//    function UpdateCandidateInfo(laptopAssetTrackingID, cellAssetTrackingID, bbAssetTrackingID, ceAssetTrackingID, dcAssetTrackingID, laptopstatus, cellstatus, bbstatus, cestatus, dcstatus, laptopcomments, cellcomments, bbcomments, cecomments, dccomments, laptopFedex, cellFedex, bbFedex, ceFedex, dcFedex, laptopddate, cellddate, bbddate, ceddate, dcddate, z10AssetTrackingID, q10AssetTrackingID, samsungS3AssetTrackingID, samsungS4AssetTrackingID, samsungS5AssetTrackingID, iPhone4SAssetTrackingID, iPhone5CAssetTrackingID, iPhone5SAssetTrackingID, z10status, q10status, samsungS3status, samsungS4status, samsungS5status, iPhone4Sstatus, iPhone5Cstatus, iPhone5Sstatus, z10Comments, q10Comments, samsungS3Comments, samsungS4Comments, samsungS5Comments, iPhone4SComments, iPhone5CComments, iPhone5SComments, z10FedEx, q10FedEx, samsungS3FedEx, samsungS4FedEx, samsungS5FedEx, iPhone4SFedEx, iPhone5CFedEx, iPhone5SFedEx, z10ddate, q10ddate, samsungS3ddate, samsungS4ddate, samsungS5ddate, iPhone4Sddate, iPhone5Sddate, iPhone5Cddate, divmsg) {
    function UpdateCandidateInfo(laptopissuedAssetTrackingID, androidAssetTrackingID, clientlaptopAssetTrackingID, laptopAssetTrackingID, cellAssetTrackingID, bbAssetTrackingID, ceAssetTrackingID, dcAssetTrackingID, z10AssetTrackingID, q10AssetTrackingID, samsungS3AssetTrackingID, samsungS4AssetTrackingID, samsungS5AssetTrackingID, iPhone4SAssetTrackingID, iPhone5SAssetTrackingID, iPhone5CAssetTrackingID, lgg2AssetTrackingID, samsungNote3AssetTrackingID, samsungNote4AssetTrackingID, iPhone6AssetTrackingID, iPhone6PAssetTrackingID, lgg3AssetTrackingID, samsungS632GBAssetTrackingID, samsungS664GBAssetTrackingID, samsungS6128GBAssetTrackingID, samsungS6Edge32GBAssetTrackingID, samsungS6Edge64GBAssetTrackingID, samsungS6Edge128GBAssetTrackingID, laptopissuedstatus, androidstatus, clientlaptopstatus, laptopstatus, cellstatus, bbstatus, cestatus, dcstatus, z10status, q10status, samsungS3status, samsungS4status, samsungS5status, iPhone4Sstatus, iPhone5Sstatus, iPhone5Cstatus, lgg2status, samsungNote3status, samsungNote4status, iPhone6status, iPhone6Pstatus, lgg3status, samsungS632GBstatus, samsungS664GBstatus, samsungS6128GBstatus, samsungS6Edge32GBstatus, samsungS6Edge64GBstatus, samsungS6Edge128GBstatus, laptopissuedcomments, androidcomments, clientlaptopcomments, laptopcomments, cellcomments, bbcomments, cecomments, dccomments, z10Comments, q10Comments, samsungS3Comments, samsungS4Comments, samsungS5Comments, iPhone4SComments, iPhone5SComments, iPhone5CComments, lgg2Comments, samsungNote3Comments, samsungNote4Comments, iPhone6Comments, iPhone6PComments, lgg3Comments, samsungS632GBComments, samsungS664GBComments, samsungS6128GBComments, samsungS6Edge32GBComments, samsungS6Edge64GBComments, samsungS6Edge128GBComments, laptopissuedFedex, androidFedex, clientlaptopFedex, laptopFedex, cellFedex, bbFedex, ceFedex, dcFedex, z10FedEx, q10FedEx, samsungS3FedEx, samsungS4FedEx, samsungS5FedEx, iPhone4SFedEx, iPhone5SFedEx, iPhone5CFedEx, lgg2FedEx, samsungNote3FedEx, samsungNote4FedEx, iPhone6FedEx, iPhone6PFedEx, lgg3FedEx, samsungS632GBFedEx, samsungS664GBFedEx, samsungS6128GBFedEx, samsungS6Edge32GBFedEx, samsungS6Edge64GBFedEx, samsungS6Edge128GBFedEx, laptopissuedddate, androidddate, clientlaptopddate, laptopddate, cellddate, bbddate, ceddate, dcddate, z10ddate, q10ddate, samsungS3ddate, samsungS4ddate, samsungS5ddate, iPhone4Sddate, iPhone5Sddate, iPhone5Cddate, lgg2ddate, samsungNote3ddate, samsungNote4ddate, iPhone6ddate, iPhone6Pddate, lgg3ddate, samsungS632GBddate, samsungS664GBddate, samsungS6128GBddate, samsungS6Edge32GBddate, samsungS6Edge64GBddate, samsungS6Edge128GBddate, divmsg) {

        //alert(laptopAssetTrackingID);
        //sree
        var laptopissuedAssetTrackingIDValue;
        var androidAssetTrackingIDValue;
        var clientlaptopAssetTrackingIDValue;
        ...
        var laptopissuedstatusValue;
        var androidstatusValue;
        var clientlaptopstatusValue;
        ...
        var laptopissuedcommentsValue;
        var androidcommentsValue;
        var clientlaptopcommentsValue;
        ...
        var laptopissuedFedexValue;
        var androidFedexValue;
        var clientlaptopFedexValue;
        ...
        var laptopissuedddateValue;
        var androidddateValue;
        var clientlaptopddateValue;
        ...
        if (laptopissuedstatus != null) {
            if (laptopissuedstatus.value == "5" || laptopissuedstatus.value == "6") {
                laptopissuedFedex.value = "";
                laptopissuedddate.value = '1/1/1900';
            }
            else if (laptopissuedstatus.value != "14") {
                laptopissuedcomments.value = "";
                laptopissuedFedex.value = "";
                laptopissuedddate.value = '1/1/1900';
            }
        }
        if (androidstatus != null) {
            if (androidstatus.value == "5" || androidstatus.value == "6") {
                androidFedex.value = "";
                androidddate.value = '1/1/1900';
            }
            else if (androidstatus.value != "14") {
                androidcomments.value = "";
                androidFedex.value = "";
                androidddate.value = '1/1/1900';
            }
        }

        if (clientlaptopstatus != null) {
            if (clientlaptopstatus.value == "5" || clientlaptopstatus.value == "6") {
                clientlaptopFedex.value = "";
                clientlaptopddate.value = '1/1/1900';
            }
            else if (clientlaptopstatus.value != "14") {
                clientlaptopcomments.value = "";
                clientlaptopFedex.value = "";
                clientlaptopddate.value = '1/1/1900';
            }
        }
        ...
        if (laptopissuedAssetTrackingID != null) {
            laptopissuedAssetTrackingIDValue = laptopissuedAssetTrackingID.value;
        }
        else {
            laptopissuedAssetTrackingIDValue = "";
        }

        if (androidAssetTrackingID != null) {
            androidAssetTrackingIDValue = androidAssetTrackingID.value;
        }
        else {
            androidAssetTrackingIDValue = "";
        }

        if (clientlaptopAssetTrackingID != null) {
            clientlaptopAssetTrackingIDValue = clientlaptopAssetTrackingID.value;
        }
        else {
            clientlaptopAssetTrackingIDValue = "";
        }
        ...
        if (laptopissuedstatus != null) {
            laptopissuedstatusValue = laptopissuedstatus.value;
        }
        else {
            laptopissuedstatusValue = "";
        }

        if (androidstatus != null) {
            androidstatusValue = androidstatus.value;
        }
        else {
            androidstatusValue = "";
        }
        if (clientlaptopstatus != null) {
            clientlaptopstatusValue = clientlaptopstatus.value;
        }
        else {
            clientlaptopstatusValue = "";
        }
        if (laptopstatus != null) {
        ...
        if (laptopissuedcomments != null) {
            laptopissuedcommentsValue = laptopissuedcomments.value;
        }
        else {
            laptopissuedcommentsValue = "";
        }

        if (androidcomments != null) {
            androidcommentsValue = androidcomments.value;
        }
        else {
            androidcommentsValue = "";
        }
        if (clientlaptopcomments != null) {
            clientlaptopcommentsValue = clientlaptopcomments.value;
        }
        else {
            clientlaptopcommentsValue = "";
        }
        ...
        if (laptopissuedFedex != null) {
            laptopissuedFedexValue = laptopissuedFedex.value;
        }
        else {
            laptopissuedFedexValue = "";
        }
        if (androidFedex != null) {
            androidFedexValue = androidFedex.value;
        }
        else {
            androidFedexValue = "";
        }

        if (clientlaptopFedex != null) {
            clientlaptopFedexValue = clientlaptopFedex.value;
        }
        else {
            clientlaptopFedexValue = "";
        }
        if (laptopFedex != null) {
        ...
        if (laptopissuedddate != null) {
            laptopissuedddateValue = laptopissuedddate.value;
        }
        else {
            laptopissuedddateValue = "";
        }
        if (androidddate != null) {
            androidddateValue = androidddate.value;
        }
        else {
            androidddateValue = "";
        }

        if (clientlaptopddate != null) {
            clientlaptopddateValue = clientlaptopddate.value;
        }
        else {
            clientlaptopddateValue = "";
        }
        if (laptopddate != null) {
        ...
        var inputData = '{"laptopissuedAssetTrackingID":"' + laptopissuedAssetTrackingIDValue + '","androidAssetTrackingID" : "' + androidAssetTrackingIDValue + '","clientlaptopAssetTrackingID" : "' + clientlaptopAssetTrackingIDValue + '","laptopAssetTrackingID" : "' + laptopAssetTrackingIDValue + '","cellAssetTrackingID" : "' + cellAssetTrackingIDValue + '","bbryAssetTrackingID" :"' + bbAssetTrackingIDValue + '","ceqpAssetTrackingID" :"' + ceAssetTrackingIDValue + '","dcardAssetTrackingID" :"' + dcAssetTrackingIDValue + '","laptopissuedstatus" : "' + laptopissuedstatusValue + '","androidstatus" : "' + androidstatusValue + '","clientlaptopstatus" : "' + clientlaptopstatusValue + '","laptopstatus" : "' + laptopstatusValue + '","cellstatus":"' + cellstatusValue + '","bbstatus" : "' + bbstatusValue + '","cestatus" : "' + cestatusValue + '","dcstatus" : "' + dcstatusValue + '","laptopissuedcomments" : "' + laptopissuedcommentsValue + '","androidcomments" : "' + androidcommentsValue + '","clientlaptopcomments" : "' + clientlaptopcommentsValue + '","laptopcomments" : "' + laptopcommentsValue + '","cellcomments" : "' + cellcommentsValue + '","bbcomments" : "' + bbcommentsValue + '","cecomments" : "' + cecommentsValue + '","dccomments" : "' + dccommentsValue + '","laptopissuedFedex" : "' + laptopissuedFedexValue + '","androidFedex" : "' + androidFedexValue + '","clientlaptopFedex" : "' + clientlaptopFedexValue + '","laptopFedex" : "' + laptopFedexValue + '","cellFedex" : "' + cellFedexValue + '","bbryFedex" : "' + bbFedexValue + '","ceqpFedex" : "' + ceFedexValue + '","dcardFedex" : "' + dcFedexValue + '","laptopissuedddate" : "' + laptopissuedddateValue + '","androidddate" : "' + androidddateValue + '","clientlaptopddate" : "' + clientlaptopddateValue + '","laptopddate" : "' + laptopddateValue + '","cellddate" : "' + cellddateValue + '","bbddate" : "' + bbddateValue + '","ceddate" : "' + ceddateValue + '","dcddate" : "' + dcddateValue + '","z10AssetTrackingID" : "' + Z10AssetTrackingIdValue + '","q10AssetTrackingID" : "' + Q10AssetTrackingIdValue + '","samsungS3AssetTrackingID" : "' + SamsungS3AssetTrackingIdValue + '","samsungS4AssetTrackingID" : "' + SamsungS4AssetTrackingIdValue + '","samsungS5AssetTrackingID" : "' + SamsungS5AssetTrackingIdValue + '","iphone4SAssetTrackingID" : "' + IPhone4SAssetTrackingIdValue + '","iphone5SAssetTrackingID" : "' + IPhone5SAssetTrackingIdValue + '","iphone5CAssetTrackingID" : "' + IPhone5CAssetTrackingIdValue + '","lgg2AssetTrackingID" : "' + lgg2AssetTrackingIdValue + '","samsungNote3AssetTrackingID" : "' + samsungNote3AssetTrackingIdValue + '","samsungNote4AssetTrackingID" : "' + samsungNote4AssetTrackingIdValue + '","iPhone6AssetTrackingID" : "' + iPhone6AssetTrackingIdValue + '","iPhone6PAssetTrackingID" : "' + iPhone6PAssetTrackingIdValue + '","lgg3AssetTrackingID" : "' + lgg3AssetTrackingIdValue + '","samsungS632GBAssetTrackingID" : "' + samsungS632GBAssetTrackingIdValue + '","samsungS664GBAssetTrackingID" : "' + samsungS664GBAssetTrackingIdValue + '","samsungS6128GBAssetTrackingID" : "' + samsungS6128GBAssetTrackingIdValue + '","samsungS6Edge32GBAssetTrackingID" : "' + samsungS6Edge32GBAssetTrackingIdValue + '","samsungS6Edge64GBAssetTrackingID" : "' + samsungS6Edge64GBAssetTrackingIdValue + '","samsungS6Edge128GBAssetTrackingID" : "' + samsungS6Edge128GBAssetTrackingIdValue +
