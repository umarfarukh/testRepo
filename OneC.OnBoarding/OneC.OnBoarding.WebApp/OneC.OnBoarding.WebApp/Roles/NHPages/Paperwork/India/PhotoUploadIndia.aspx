<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhotoUploadIndia.aspx.cs"
    Inherits="OneC.OnBoarding.WebApp.Roles.NHPages.Paperwork.India.PhotoUploadIndia" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../../Scripts/Forms/India/PhotoUploadIndia.js" type="text/javascript"></script>
                                ...
                                <div id="main" style="display: block; overflow: scroll; height: 350px; position: relative">
                                    ...
                                    <div class="fleft wrap_left">
                                        ...
                                        <div class="fleft width100per paddingB20L5">
                                            <asp:Button ID="Upload" class="done_btn marginTL20 font13" runat="server" OnClick="Button1_Click"
                                                OnClientClick="UploadFormDetails();" Text="Upload" />
                                            <asp:Button ID="Upload1" class="done_btn marginTL20 font13" runat="server" OnClick="Button2_Click"
                                                OnClientClick="UploadFormDetails();" Text="Upload" />
                                            <%--        <asp:Button ID="Button1" class="done_btn marginTL20 font13" runat="server" OnClick="Button3_Click"
                                                OnClientClick="UploadFormDetails();" Text="Delete" />--%>
                                        </div>
                                    </div>
                                    <div class="photo_info" style="float: right">
                                       ...
                                       <%-- <p class="color_red font11" id="noteForUpload" style="display: none">
                                            Please check your photograph before submitting. Once uploaded, the photo cannot be edited or modified.</p>
                                        <p>--%>
                                            <div id="nameDivCandidateView">
                                                <p class="color_red font11">
                                                    <%-- *(maximum permissible characters is 19)--%>
                                                    *(Please ensure that your First Name and Last Name together do not exceed 19 characters. )</p>
                                                <p>
                                                    <label for="firstName">
                                                        First Name:</label></p>
                                                ...
                                                <div id="autosuggestion" style="font-size: 1.3em">
                                                    <%--   <input type="radio" id="suggestedname" style="font-size: 1.3em" jqxb-datasource="FormDetails"
                                                    jqxb-datamember="PhotoUpload.SuggestedName" />
                                                    --%>
                                                </div>
                                                <p>
                                                    <label for="name">
                                                        Name to be displayed on ID card:</label></p>
                                                <input type="text" id="nameOnIDCard" name="nameOnIDCard" style="font-size: 1.3em"
                                                    jqxb-datasource="FormDetails" jqxb-datamember="PhotoUpload.NameOnIDCard" />
                                            </div>
                                            ...
                                            <div id="nameDivAdminView" style="display: none">
                                                ...
                                                <p>
                                                    <label for="name" id="adminlabel">
                                                        Name to be displayed on ID card:</label></p>
                                                <p class="color_red font11" id="nameInfo">
                                                    <%-- *(maximum permissible characters
                                        is 20)--%>
                                                    *(The maximum permissible characters for 'Name to be displayed on ID card' is 20
                                                    characters including the space.)</p>
                                                <input type="text" id="nameOnIDCardamin" style="font-size: 1.3em" />
                                                <%--<p>
                                    ...
                                    <input type="text" id="adminDeliveryAddress" style="font-size: 1.3em" />--%>
                                            ...
                                            <div id="acceptRejectDiv" style="display: none">
                                                ...
                                                <input type="checkbox" id="displayNameCheckBox" class="marginR5" /><label for="display_name">IDCard
                                                    ...
                                                    <select style="border: 1px solid #000; height: 25px; width: 145px" id="rejectreasons"
                                                        name="Reasons" jqxb-datasource="FormDetails" jqxb-datamember="PhotoUpload.Remarks"
                                                        jqxb-listsource="ReasonsforRejection" jqxb-listvalue="ID" jqxb-listtext="Description">
                                                    </select><br />
                                                    <br />
                                                    <br />
                                                    <textarea id="remarksTextArea" class="height50" style="font-size: 1.3em; display: none;"
                                                        jqxb-datasource="FormDetails" jqxb-datamember="PhotoUpload.OtherRemarks"></textarea><br />
                                            ...
                                            <!--acceptRejectDiv-->
                                            <p class="paddingB20">
                                                <input style="display: none" type="button" class="done_btn" id="doneButton" title="Done"
                                                    value="Done" onclick="return ValidateSave();" />
                                ...
                                <div>
                                    <div class="pre fleft" style="float: left; padding-right: 0px; width: 50%;">
                                        ...
                                        <ul>
                                            ...
                                            <li>Valid File Formats for the Image:png,jpg,gif,bmp</li>
                                    ...
                                    <div class="pre fleft" style="width: 50%; float: right; padding-top: 8px;">
                                        ...
                                        <ul>
                                            ...
                                            <li>No head gear/hat,etc unless you wear it habitually on account of religious reasons
                                                .</li>
