...
namespace OneC.OnBoarding.WebApp.Roles.NHPages.Paperwork.Ireland
{
    using System;
    ...
    public partial class PhotoUpload : System.Web.UI.Page
    {
        ...
        /// <param name="countryID">Country Candidate belongs to</param>
        /// <param name="candidateID">CandidateId of logged in candidate</param>
        /// <returns>Send Rejection MAil</returns>
