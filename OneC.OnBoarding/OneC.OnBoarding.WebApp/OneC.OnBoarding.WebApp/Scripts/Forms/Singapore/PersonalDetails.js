$().ready(function () {
    ...
    OBPager.GetMaster(183, "NationalIdType");
    ...
    if (taskObj.IsNationalIdNA == 'true' || taskObj.IsNationalIdNA == '1') {
        ...
        $('#natidtype_form').attr("disabled", "true").removeClass('dropdown');
        $('#natidtype_form').addClass('notMandatory');
        $('.natidcls').parent('label').addClass('notMandatory');
        $('.natidcls').hide();
        ...
        $('#natidtype_form').removeAttr('disabled').removeClass('notMandatory');
        $('#natidtype_form').addClass('dropdown');
        $('.natidcls').parent('label').removeClass('notMandatory');
        $('.natidcls').show();
        //$('#natidDiv').show();
    ...
    $('#nationality_form').change(function () {
        ...
        if (nationality != -1) {
            ...
            OBPager.GetGeographyMaster(64, nationality, "CitizenshipList");
        }
    });

    $('#citizenship_form').change(function () {
        var CitizenShip = $('#citizenship_form').val();
        OBPager.SetTaskContentMemberValue('PersonalData.CitizenshipStatus', 1, CitizenShip, false);
        var nationality = $('#nationality_form').val();
        if (CitizenShip != -1) {
            if (CitizenShip == 'PR') {
                $('#PrEffDate_li').show();
                $('#PREff_form').removeAttr('disabled');
                
                $("#PREff_form").datepicker('enable');
                //  OBPager.SetTaskContentMemberValue('PersonalData.PREffectiveDate', 1, '', false);
            }
            else {
                $('#PrEffDate_li').hide();
                $('#PREff_form').attr("disabled", "true");
              
                OBPager.SetTaskContentMemberValue('PersonalData.PREffectiveDate', 1, null, false);
            }
        }
        jQXB.doBind(OBPager.taskContentDSName);
...
function PrePopulateValues() {
    ...
    var Citizenship = JSON.parse(OBPager.strFormDetails).PersonalData.CitizenshipStatus;
    if (Citizenship != -1 && Citizenship != null && Citizenship != '') {
        if (Citizenship == 'PR') {
            $('#PrEffDate_li').show();
            $('#PREff_form').removeAttr('disabled');
            ...
            //OBPager.SetTaskContentMemberValue('PersonalData.PREffectiveDate', 1, $('#PREff_form').value, false);
        }
        else {
            $('#PrEffDate_li').hide();
            $('#PREff_form').attr("disabled", "true");
...
function checkNIDNA() {
    ...
    //if (document.getElementById('NationalIDNA').checked == true) {
        ...
        OBPager.SetTaskContentMemberValue('PersonalData.NationalIdType', null, '-1', false);
        ...
        OBPager.SetTaskContentMemberValue('PersonalData.NationalId', 1, '', false);
        OBPager.SetTaskContentMemberValue('PersonalData.NationalIdType', null, '-1', false);
        $('#natidtype_form').removeAttr('disabled').addClass('dropdown');
        $('#natidtype_form').removeClass('notMandatory');
