...
$().ready(function () {
    ...
    if (OBPager.taskStatusFlag == "-1") {
        ...
        OBPager.SetTaskContentMemberValue('PersonalData.CurrentCountry', null, '-1', true);
        OBPager.SetTaskContentMemberValue('PersonalData.AccountType', null, '-1', true);
        OBPager.SetTaskContentMemberValue('PersonalData.BankCountry', null, '-1', true);
