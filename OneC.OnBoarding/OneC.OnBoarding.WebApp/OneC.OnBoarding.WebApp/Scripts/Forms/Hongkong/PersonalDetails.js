$().ready(function () {
    ...
    if (taskObj.IsSameCurrPermAddress == 'false' || taskObj.IsSameCurrPermAddress == '0' || taskObj.IsSameCurrPermAddress == null) {
        $('#chkpermAddress_form').attr('checked', false);
    }
    else
        $('#chkpermAddress_form').attr('checked', 'checked');

    if (taskObj.IsSameCurrlngAddress == 'false' || taskObj.IsSameCurrlngAddress == '0' || taskObj.IsSameCurrlngAddress == null) {
        $('#chklngstyaddress_form').attr('checked', false);
    }
    else
...
function SaveTaskData(saveMode) {
    ...
    OBPager.SetTaskContentMemberValue('PersonalData.NationalId', null, $('#NatID_form')[0].value, false);
