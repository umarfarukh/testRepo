//-----------------------------------------------------------------------
// <copyright file="Validation.cs" company="CTS">
...
namespace OneC.OnBoarding.DC.BGVDC
{
    ...
    /// <summary>
    /// Represents component validation
    /// </summary>
    [Serializable]
    public class Validation
    {
        ...
        /// <summary>
        /// Gets or sets CompData
        /// </summary>
        [DataMember(Name = "CompDetail", Order = 3)]
        ...
        /// <summary>
        /// Gets or sets TotalExperience
        /// </summary>
        [DataMember(Name = "TotalExp", Order = 4)]
        public int TotalExp
        {
            get;
            set;
        ...
        /// </summary>
        public Collection<string> ReturnMessage
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// Represents the component data validate parameters
    /// </summary>
    [Serializable]
    public class ValidateComponentData
    {
        /// <summary>
        /// Gets or sets the value of Session Id.
        /// </summary>
    ...
    /// <summary>
    /// Represents the personal data validate parameters
    /// </summary>
    [Serializable]
