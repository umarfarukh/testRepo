        ...
        $('.reject_request_popup .disagree_btn').bind("click", function () {
            ...
            if (RejectionComment == 'Please provide a reason for rejection...' || RejectionComment == null || RejectionComment == '') {
                ...
                $.ajax({
                    ...
                    contentType: 'application/json',
                    data: "{JoineeId:'" + JoineeId + "',BuddyId:'" + BuddyId + "',RequestType:'" + RequestType + "',RejectionComment:'" + RejectionComment + "'}",
                    dataType: 'json',
                    processData: false,
        ...
        $('.history_left_item').livequery('click', function () {
            ...
            if (thisObjIndex < historyArray.length) {
                ...
                if (request.status === 200) {
                    ...
                    $("#JoineeImage").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
                }
...
//        $('#buddy_view_notifications .').bind('click', function (){ 
//            GetAlerts();
//        });
                ...
                case 'buddy_request_notifications_content':
                    if (thisObjIndex < buddyRequestNotificationsArray.length) {
                        ...
                        if (request.status === 200) {
                            ...
                            $("#Joinee_Image").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
                        }
                    }
                    break;
                case 'alerts_notifications_content':
                    if (thisObjIndex < alertsNotificationArray.length) {
                        ...
                        if (request.status === 200) {
                            ...
                            $("#Joinee_Image1").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
                        }
                    }
                    break;
                ...
                case 'team_members_notifications_content':
                    if (thisObjIndex < alertsNotificationArray.length) {
                        ...
                        if (request.status === 200) {
                            ...
                            $("#Joinee_Image3").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
                        }
                    }
                    break;
                case 'others_notifications_content':
                    if (thisObjIndex < othersNotificationArray.length) {
                        ...
                        if (request.status === 200) {
                            ...
                            $("#Joinee_Image2").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
                        }
                    }
                    break;
                default:
...
var adminNS = {
    init: function () {
            ...
            switch (tabContentClassName) {
                case 'dashboard_content_wrapper':
                    if (thisObjIndex < connectionsArray.length) {
                        ...
                        if (HistorySelectedUserEmailId != false || HistorySelectedUserEmailId != null || HistorySelectedUserEmailId != 'undefined') {
                            $("#buddy_name").html('');
                            $("#buddy_name").append(name + "        " + "<br><img style='cursor:pointer;' src='Resources/Images/presence_16-unknown.png' id ='imgCommunicatorStatus' title='Status' /><img title='Ping me' src='../../Resources/Images/NA/communicator3.png' style='width:20px;cursor:pointer;margin-left:3px;' onclick='OpenCommunicatorTileView();'/><img src='../../Resources/Images/NA/outlook.jpg' style='width:20px;cursor:pointer;margin-left:4px;' title='Mail' onclick='SendEmail();'/>");
                        }
                        else {
                            $("#buddy_name").html('');
                        ...
                        if (request.status === 200) {
                            ...
                            $("#buddy_img").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
                        }
                    }
                    break;
                default:
       ...
       $('#buddy_view_history .feedback_btn').bind('click', function () {
        ...
        $('#admin_view_buddy .feedback_popup_close').bind('click', function () {
            $('.feedback_popup, .overlay').hide();
        });
            ...
            if (i < Buddies.BuddyList.length) {
                ...
                if (Buddies.BuddyList[i].Gender == 'M') {
                    ...
                    if (request.status === 200) {
                        ...
                        Buddy += "<img class='background-size-cover dummy_image' src='../../Resources/Images/NA/dummy_image_male_large.jpg'  />";
                    }
                    else {
                    ...
                    if (request.status === 200) {
                        Buddy += "<img class='background-size-cover profile_pic' runat='server' src='ShowImage.ashx?id=" + Buddies.BuddyList[i].UserId + "' alt='' />";
                        Buddy += "<img class='background-size-cover dummy_image' src='../../Resources/Images/NA/dummy_image_female_large.jpg'  />";
                    }
                    else {
                        Buddy += "<img class='background-size-cover profile_pic profile_pic_buddy_list' />";
                        Buddy += "<img class='background-size-cover dummy_image' src='../../Resources/Images/NA/dummy_image_female_large.jpg'  />";
...
function OnSuccessGetContactCard(result) {
    ...
    if (ContactCard.UserId != 'Not Available' || ContactCard.UserId != '') {
        ...
        if (request.status === 200) {
            ...
            $("#ccPhoto").attr('src', '../../Resources/Images/NA/dummy_image.jpg');
        }
            ...
            if (j != outerCount - 1 || outerCount == 1) {
                for (k = 0; k < Math.min(RecommendableJoinees.JoineeList.length, 9); k++) {
                    ...
                    if (request.status === 200) {
                        ...
                        Joinee += "<img class='background-size-cover' src='../../Resources/Images/NA/dummy_image.jpg'  />";
                    }
            ...
            if (j != outerCount - 1 || outerCount == 1) {
                for (k = 0; k < Math.min(RecommendableBuddies.BuddyList.length, 9); k++) {
                    ...
                    if (request.status === 200) {
                        ...
                        Buddy += "<img class='background-size-cover dummy_image' src='../../Resources/Images/NA/dummy_image.jpg'  />";
                    }
    ...
    if (Joinees.objMyPendingConnections.length == null || Joinees.objMyPendingConnections.length == 0) {
        ...
        for (var i = 0; i < a; i++) {
            ...
            if (request.status === 200) {
                ...
                list += "<span class='notifications_left_image'><img class='background-size-cover' src='../../Resources/Images/NA/dummy_image.jpg' /></span>";
            }
    ...
    if (Buddies.MyConnections != null) {
        ...
        for (var i = 0; i < a; i++) {
            ...
            if (request.status === 200) {
                ...
                list += "<span class='history_left_image'><img class='background-size-cover' src='../../Resources/Images/NA/dummy_image.jpg' /></span>";
            }
            ...
            if (Configuration[0].BuddyDuration != null) {
                ...
                if (Configuration[0].CountryList.length > 0) {
                    for (var i = 0; i < Configuration[0].CountryList.length; i++) {
                        list += '<li id="' + Configuration[0].CountryList[i].CountryId + '">' + Configuration[0].CountryList[i].CountryDesc + '<a href="#"><img src="../../Resources/Images/NA/go_arrow.png" alt="Arrow" class="dropdown_select_arrow"/></a></li>';
                    }
                }
    ...
    if (a != 0) {
        ...
        for (var i = 0; i < a; i++) {            
            ...
            if (request.status === 200) {
                ...
                list += "<span class='notifications_left_image'><img class='background-size-cover' src='../../Resources/Images/NA/dummy_image.jpg'  alt='Image'/></span>";
            }
        ...
        if (HistorySelectedUserEmailId != false) {
            $("#buddy_name").html('');
            $("#buddy_name").append(buddy.DashBoardData[0].BuddyName + "        " + "<br><img style='cursor:pointer;' src='../../Resources/Images/NA/presence_16-unknown.png' id ='imgCommunicatorStatus' title='Status' /><img title='Ping me' src='../../Resources/Images/NA/communicator3.png' style='width:20px;cursor:pointer;margin-left:3px;' onclick='OpenCommunicatorTileView();'/><img src='../../Resources/Images/NA/outlook.jpg' style='width:20px;cursor:pointer;margin-left:4px;' title='Mail' onclick='SendEmail();'/>");
        }
        else {
            $("#buddy_name").html('');
        ...
        if (a < 3) {
            ...
            for (i = 0; i < a; i++) {
                ...
                if (request.status === 200) {
                    ...
                    list += "<div class='thumbnail80'><img class='background-size-cover' id='Connected_img' alt='User' src='../../Resources/Images/NA/dummy_image.jpg' /></div>";
                }
        ...
        if (Admins != null) {
            ...
            for (var i = 0; i < Admins[0].length; i++) {
                ...
                if (request.status === 200) {
                    ...
                    AdminView = AdminView + '<span class="notifications_left_image"><img class="background-size-cover" src="../../Resources/Images/NA/dummy_image.jpg" /></span>';
                }
                ...
                AdminView = AdminView + '<a href="#" class="remove_admin_icon"><img src="../../Resources/Images/NA/remove_admin.png" alt="Remove Admin"  onclick="RemovingAdmin(' + Admins[0][i].UserId + ')" /></a></div>';
...
function GetFeedbackQuestions() {
    ...
    $.ajax({
        ...
        contentType: 'application/json',
        data: "{BuddyId:'" + BuddyId + "',JoineeId:'" + JoineeId + "',ReviewType:'" + ReviewType + "'}",
        dataType: 'json',
        processData: false,
        success: function (response) {
...
function OnSuccessGetFeedbackQuestions(response) {
    ...
    if (Questions.objFeedbackQuestions.length != 0) {
        ...
        for (var i = 0; i < length; i++) {
            ...
            $('input:radio[name=' + Questions.objFeedbackQuestions[i].QuestionID + '][value=' + Questions.objFeedbackQuestions[i].Feedback + ']').attr('checked', true);

            var radios = document.getElementsByName('' + Questions.objFeedbackQuestions[i].QuestionID + '');
    ...
    if (a != 0) {
        for (i = 0; i < a; i++) {
            ...
            if (request.status === 200) {
                ...
                list += "<img class='background-size-cover' src='../../Resources/Images/NA/dummy_image.jpg'  alt='Image'/>";
            }
...
function GetAverageFeedback() {
    ...
    $.ajax({
        type: 'POST',
        url: 'admin_view_buddy.aspx/GetAverageFeedback',
        contentType: 'application/json',
        data: "{BuddyId:'" + BuddyId + "',JoineeId:'" + JoineeId + "',ReviewType:'" + ReviewType + "'}",
        dataType: 'json',
        processData: false,
        success: function (response) {
            OnSuccessGetAverageFeedback(response);
        },
        error: function (xhr, ajaxOptions, thrownError) {
            OnErrorGetAverageFeedback(xhr.status, thrownError);
        }
    });
}

function OnSuccessGetAverageFeedback(response) {
    var Questions = eval('(' + response.d + ')');
    var length = Questions.objAvgFeedback.length;

    if (Questions.objAvgFeedback.length != 0) {
        $('.feedback_popup, .overlay').fadeIn();


        for (var i = 0; i < length; i++) {

            document.getElementById('Question' + i).innerHTML = Questions.objAvgFeedback[i].QuestionText;

            $('input:radio[name=' + Questions.objAvgFeedback[i].QuestionID + '][value=' + Questions.objAvgFeedback[i].Feedback + ']').attr('checked', true);

            var radios = document.getElementsByName('' + Questions.objAvgFeedback[i].QuestionID + '');
            for (var j = 0; j < radios.length; j++) {
                radios[j].disabled = true;
            }
        }
