			...
			switch(type){
				...
				case 'tooltip':
					...
					$that.on('mouseenter', function(e){
						...
						if($that.hasClass('search_btn')){
							$tip.css('top', (e.pageY-85-$(window).scrollTop())).css('left', e.pageX - 125).stop(true, true).fadeIn(200);
						}else if($that.hasClass('menu_btn')){
							$tip.css('top', (e.pageY+20-$(window).scrollTop())).css('left', e.pageX).stop(true, true).fadeIn(200);
						}else{
							$tip.css('top', (e.pageY-$(window).scrollTop())).css('left', e.pageX).stop(true, true).fadeIn(200);
						}
