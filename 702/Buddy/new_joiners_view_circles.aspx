<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New_joiners_view_circles.aspx.cs" Inherits="Buddy.New_joiners_view_circles" %>
...
<body id="New_joiners_view_circles">
		<div id="wrapper">
			...
			<div class="circles_wrapper">
				<div class="cindy_callout_wrapper clear">
					<div class="cindy_callout">
						...
						<p>Please select your buddy from the Circles you may know... </p>
					</div>
					<div class="search_wrapper">
						<p>Search for your Buddy here :</p>
						<input type="text" class="searchBox" id="Searchtext" value="Search by name or Id"/>
						<button class="search_btn"></button>
						<a class="dashboard_btn ask_your_supervisor" href="#">Request your supervisor for a buddy</a>
					</div>
				</div>
				<div class="circles">
