//-----------------------------------------------------------------------
// <copyright file="buddy_view_storyline.aspx.cs" company="Cognizant">
...
namespace Buddy
{
    ...
    /// <summary>
    /// class for buddy view storyline
    /// </summary>
    public partial class Buddy_view_storyline : System.Web.UI.Page
    {
        /// <summary>
        ...
        /// <param name="role">for Role</param>
        /// <returns>a value</returns>
        [WebMethod]
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.AcceptanceCountOfRegBuddy.Value = HttpContext.Current.Session["AcceptanceCountOfRegBuddy"].ToString();
                this.AcceptanceCountOfUnRegBuddy.Value = HttpContext.Current.Session["AcceptanceCountOfUnRegBuddy"].ToString();
                this.ConnectionsOfJoiners.Value = HttpContext.Current.Session["ConnectionsOfJoiners"].ToString();
