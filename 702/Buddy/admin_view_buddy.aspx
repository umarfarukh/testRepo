<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_view_buddy.aspx.cs" Inherits="Buddy.Admin_view_buddy" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div id="wrapper">
            <div class="header clear">
                ...
                <a href="Admin_view_buddy.aspx" class="menu_btn admin_view_btn selected"></a>
            ...
            <div class="admin_view_wrapper clear">
                ...
                <div class="main_tabs">
                    <div id="configure_tab" style="display: none" class="main_tab_item selected">
                        <p>Configure</p>
                    </div>
                    <div id="dashboard_tab" style="display: none" class="main_tab_item" onclick="GetDashBoardTabPrefillValues();">
                        <p>Dashboard</p>
                    </div>
                    <div id="recommendations_tab" style="display: none" class="main_tab_item">
                        <p>Supervisor's view</p>
                    </div>
                    <div id="add_admin_tab" style="display: none" class="main_tab_item" onclick="GetAdminList();disableSubmit()">
                        <p>Add Admin</p>
                    </div>
                </div>
                <div class="admin_view_content">
                    <div id="configure_tab_content" style="display: none">
                        <div class="configure_tab_content_wrapper clear">
                                    ...
                                    <div class="dropdown_wrapper">
                                        <div class="dropdown_box">
                                            ...
                                            <span class="dropdown_arrow">
                                                <img src="Resources/Images/dropdown_arrow.png" alt="Arrow" /></span>
                                        </div>
                            ...
                            <div class="configure_tab_right_content fleft">
                                ...
                                <div class="configure_tab_content_item clear" style="width:230px">
									<p class="line_ht_17"><span class="item_title" style="width:100px">Country</span>:</p>
									<div class="dropdown_wrapper">
										<div class="dropdown_box">
											<span id="Span1" class="selected_item"></span>
											<span class="dropdown_arrow"><img src="Resources/Images/dropdown_arrow.png" alt="Arrow"/></span>
										</div>
										<ul id="SelectCountryId" class="dropdown_select " style="height: 132px; overflow: auto; width: 130px;">
											<%--<li>IND<a href="#"><img src="Resources/Images/go_arrow.png" alt="Arrow" class="dropdown_select_arrow"/></a></li>
											<li>SGP<a href="#"><img src="Resources/Images/go_arrow.png" alt="Arrow" class="dropdown_select_arrow"/></a></li>
											<li>USA<a href="#"><img src="Resources/Images/go_arrow.png" alt="Arrow" class="dropdown_select_arrow"/></a></li>--%>
										</ul>
									</div>
								</div>
                    ...
                    <div id="dashboard_tab_content" style="display: none">
                        <div class="notifications_content_tabs">
                            ...
                            <a href="#" style="float: right;" onclick="GetDashBoardData()">GO</a>
                        </div>
                        <div class="dashboard_content_wrapper notifications_tab_content">
                            ...
                            <div class="notifications_content_details clear">
                                <div class="notifications_content_left mousescroll" id="BuddyData">
                                </div>

                                <div class="notifications_content_right" id="Buddydata">
                                    <div class="notifications_image_name clear">
                                        <span class="notifications_right_image fleft">
                                            <img class="background-size-cover" id="buddy_img" /></span>
                                    ...
                                    <div class="dashboard_btn_wrapper clear" style="margin-left: 75px;">
                                        <a href="#" class="dashboard_btn connections_btn" onclick="GetDashboardConnectionsofUser();">Connections</a>
                                    </div>
                                </div>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td id="td_NotConnBuddy"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Connected</th>
                                                <td id="td_ConnBuddy"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div id="holder"></div>
                                    <div class="status_legend clear">
                                        <div class="legend fleft clear" style="margin-left: -25px;">
                                            <div class="legend_item fleft">
                                                ...
                                                <span class="width_112">NonConnected Buddies</span><span>: </span><span id="Non_Con_buddies"></span>
                                            </div>
                                            <div class="legend_item fleft">
                                                <div class="legend_color color_333333 fleft"></div>
                                                <span class="width_112">Connected Buddies</span><span>: </span><span id="Con_buddies"></span>
                                            </div>
                                        </div>
                        ...
                        <div id="recommend_nj_buddy_content" class="recommend_inner_tab_content">
                            ...
                            <div class="recommend_buddy_drop_area fleft">
                                <div class="drop_area_wrapper clear">
                                    <div id="drop_area_newjoiner" class="drop_area_newjoiner fleft">
                                        <p class="drop_area_text">Drag New Joiner here</p>
                                    </div>
                                    <a href="#" class="recommend_btn fleft">
                                        <img src="Resources/Images/go_arrow_white.png" alt="Go" />
                                        <p>Recommmend</p>
                                    </a>
                                    <div id="drop_area_buddy_1" class="drop_area fleft">
                                        <p class="drop_area_text">Drag Buddy here</p>
                                    </div>
                                    <div id="drop_area_buddy_2" class="drop_area fleft">
                                        <p class="drop_area_text">Drag Buddy here</p>
                                    </div>
                                    <div id="drop_area_buddy_3" class="drop_area fleft">
                                        <p class="drop_area_text">Drag Buddy here</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="add_admin_tab_content" style="display: none">
                        <div class="notifications_content_tabs">
                            <p>Enter ID : </p>
                            <input id="AddAdminID" type="text" maxlength="6" class="add_admin_id" onfocus="if(this.value=='Enter ID here')this.value='';" onblur="if(this.value=='')this.value='Enter ID here';" value="Enter ID here" />
                            <div onclick="SerarchNAME()" id="checkAdminId" class="check_name_btn"></div>
                            <a id="addingadminid" href="#" onclick="AddAdmin()">ADD</a>
                        ...
                        <div id="adminlist" class="add_admin_content mousescroll">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="info_screen">
                ...
                <div class="info_screen_details contact_details clear">
                    <p>
                        <span>
                            <img src="Resources/Images/go_arrow.png" alt="Arrow" /></span>
                    ...
                    <p>
                        <span>
                            <img src="Resources/Images/go_arrow.png" alt="Arrow" /></span>
                        <span>Once request accepted, you will be buddy for
                            <label id="lblConnectionDuration" runat="server"></label>
                            days.</span>
                    </p>
                    <p>
                        <span>
            ...
            <div class="remove_buddy_confirmation_popup">
                ...
                <div class="confirmation_popup_details contact_details clear">
                    <p>
                        You have already enrolled as part of buddy program.<br />
                        Now, do you really want to withdraw your enrollment?
                    </p>
                    <a href="#" class="confirmation_popup_btn disagree_btn">Disagree</a>
                    <a href="#" class="confirmation_popup_btn agree_btn">Agree</a>
                </div>
