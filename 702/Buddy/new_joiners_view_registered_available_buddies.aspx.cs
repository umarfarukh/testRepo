...
// ***********************************************************************
// <copyright file="New_joiners_view_registered_available_buddies.aspx.cs" company="Cognizant Technology Solutions">
...
namespace Buddy
{
    ...
    /// <summary>
    /// Class New_joiners_view_registered_available_buddies.
    /// </summary>
    public partial class New_joiners_view_registered_available_buddies : System.Web.UI.Page ////397757
    {
        /// <summary>
        /// Gets all likely buddies.
        /// </summary>
        /// <param name="userId">The user identifier.</param>
        /// <param name="filterType">Type of the filter.</param>
        /// <param name="uptoLevel">The up to level.</param>
        ...
        /// <summary>
        /// Buddies the connection request.
        /// </summary>
        /// <param name="joineeId">The joiner identifier.</param>
        /// <param name="buddyId">The buddy identifier.</param>
        /// <param name="requestType">Type of the request.</param>
        /// <param name="rejectionComment">The rejection comment.</param>
        ...
        /// <summary>
        /// Gets the joiner notify.
        /// </summary>
        /// <param name="joineeID">The joiner identifier.</param>
        /// <returns>System. String.</returns>
        [WebMethod]
        public static string GetJoineeNotify(string joineeID)
        {
        ...
        /// <summary>
        /// Determines whether [is associate eligible] [the specified buddy identifier].
        /// </summary>
        /// <param name="buddyId">The buddy identifier.</param>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.filter_type.Value = "RegAvailable";
            }
            catch (Exception ex)
            {
